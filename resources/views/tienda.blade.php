...
<div  class="menu-lateral-ventas">
    <ul>
    <a class="ultimo-carrito " href="{{ asset('../public/carrito') }}"> <button class="boton-ultimo-carrito btn btn-success mb-3" > <i class="fa-solid fa-cart-shopping"></i> Carrito de compras<div class="numero-carrito">0</div> </button> </a> 
...
<div class="paginacion" style="margin-top: -35px; margin-left:720px "></div>
